...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void startedWakingUp(
        ...
        // Display-style devices open the launcher on every wakeup, including Cuttlefish
        // display power changes, not only a power-key press.
        if (SystemProperties.getBoolean("ro.vendor.display.wake_to_home", false)
