...
public class LockPatternUtils {
    ...
    public boolean isLockScreenDisabled(int userId) {
        ...
        boolean isDemoUser = UserManager.isDeviceInDemoMode(mContext) && userInfo != null
                && userInfo.isDemo();
        // ro.lockscreen.disable.default is also seeded into the locksettings database on
        // first boot. Read it here so an existing device picks the property up immediately.
        boolean disabledByProperty = android.os.SystemProperties.getBoolean(
